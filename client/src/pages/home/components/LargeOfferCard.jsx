  ...
  return (
    <div className={styles['large-offer-card']}>
      <div className={styles['large-offer-card-content']}>
        ...
        <Link to={`/product/${product.id}`} className={styles['large-offer-card-link']}>
      ...
      <div className={styles['large-offer-card-image-box']}>
        <img src={product.image} className={styles['large-offer-card-image']} alt={product[`${currentLanguage.code}_name`]} />
      </div>
    </div>
  );
};
